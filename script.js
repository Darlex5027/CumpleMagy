...
function dibujarecur() {
    ...
    y=1500
    if(i>=33) write("F", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(5*10*6))/2), y);
    if(i>=34) write("Fe", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(5*10*6))/2), y);
    if(i>=35) write("Fel", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(5*10*6))/2), y);
    if(i>=36) write("Feli", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(5*10*6))/2), y);
    if(i>=37) write("Feliz", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(5*10*6))/2), y);
    if(i>=38) write("c", ctx, 10, ((1500-(10*10*6))/2), y+100);
    if(i>=39) write("cu", ctx, 10, ((1500-(10*10*6))/2), y+100);
    if(i>=40) write("cum", ctx, 10, ((1500-(10*10*6))/2), y+100);
    if(i>=41) write("cump", ctx, 10, ((1500-(10*10*6))/2), y+100);
    if(i>=42) write("cumpl", ctx, 10, ((1500-(10*10*6))/2), y+100);
    if(i>=43) write("cumple", ctx, 10, ((1500-(10*10*6))/2), y+100);
    if(i>=44) write("cumplea", ctx, 10, ((1500-(10*10*6))/2), y+100);
    if(i>=45) write("cumpleañ", ctx, 10, ((1500-(10*10*6))/2), y+100);
    if(i>=46) write("cumpleaño", ctx, 10, ((1500-(10*10*6))/2), y+100);
    if(i>=47) write("cumpleaños", ctx, 10, ((1500-(10*10*6))/2), y+100);
    if(i>=48) write("H", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(9*10*6))/2), y+200);
    if(i>=49) write("He", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(9*10*6))/2), y+200);
    if(i>=50) write("Her", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(9*10*6))/2), y+200);
    if(i>=51) write("Herm", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(9*10*6))/2), y+200);
    if(i>=52) write("Herma", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(9*10*6))/2), y+200);
    if(i>=53) write("Herman", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(9*10*6))/2), y+200);
    if(i>=54) write("Hermani", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(9*10*6))/2), y+200);
    if(i>=55) write("Hermanit", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(9*10*6))/2), y+200);
    if(i>=56) write("Hermanita", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(9*10*6))/2), y+200);
    /*
    
    
    
    write("Fe", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(5*10*6))/2), y);
    write("cumpleaños", ctx, 10, ((1500-(10*10*6))/2), y+100);
    write("Hermanita", ctx, 10, ((1500-(10*10*6))/2)+(((10*10*6)-(9*10*6))/2), y+200);*/
}